<?php /* Smarty version Smarty-3.1.11, created on 2015-10-24 13:13:17
...
<?php if ($_valid && !is_callable('content_5629b84510a554_91144324')) {function content_5629b84510a554_91144324($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['color'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['color']->step = 1;$_smarty_tpl->tpl_vars['color']->total = (int)ceil(($_smarty_tpl->tpl_vars['color']->step > 0 ? 5+1 - (1) : 1-(5)+1)/abs($_smarty_tpl->tpl_vars['color']->step));
...
:</div>
						<div class="col-xs-6 col-md-9"><input type="text" class="form-control precio" color="<?php echo $_smarty_tpl->tpl_vars['color']->value;?>
" tamano="<?php echo $_smarty_tpl->tpl_vars['row']->value['idTamano'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['colores'][$_smarty_tpl->tpl_vars['color']->value];?>
" anterior="<?php echo $_smarty_tpl->tpl_vars['row']->value['colores'][$_smarty_tpl->tpl_vars['color']->value];?>
" /></div>
					</div>
				<?php } ?>
			</div>
