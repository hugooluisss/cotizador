...
switch($objModulo->getId()){
	case 'cotizador':
		...
		while(!$rs->EOF){
			$smarty->assign(strtr(strtolower($rs->fields['nombre']),'ΰαβγδηθικλμνξορςστυφωϊϋόύÿΐΑΒΓΔΗΘΙΚΛΜΝΞΟΡÒΣΤΥΦΩΪΫάέ', 'aaaaaceeeeiiiinooooouuuuyyAAAAACEEEEIIIINOOOOOUUUUY'), $rs->fields['idItem']);
			$rs->moveNext();
		}
	break;
