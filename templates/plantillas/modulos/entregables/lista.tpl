				...
				{foreach from=$lista item="row"}
					<tr>
						...
						<td style="text-align: right">
							...
							<button type="button" class="btn btn-danger btn-circle" action="eliminar" title="Eliminar" item="{$row.idEntregable}"><i class="fa fa-times"></i></button>
						</td>
					</tr>
				{/foreach}
			</tbody>
