...
CREATE TABLE `serigrafiadigital` (
  ...
  PRIMARY KEY (`idItem`),
  CONSTRAINT `fk-item` FOREIGN KEY (`idItem`) REFERENCES `item` (`idItem`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `serigrafiadigital` VALUES (29,'Tamaño A4',330.00),(30,'A4',480.01),(38,'Impresion sobre A3 color claro',230.00);
